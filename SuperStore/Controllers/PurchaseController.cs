...
namespace SuperStore.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PurchaseID,CusomerID,ProductID,CustomerID")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PurchaseID,CusomerID,ProductID,CustomerID")] Purchase purchase)
        {
            if (ModelState.IsValid)
            {
